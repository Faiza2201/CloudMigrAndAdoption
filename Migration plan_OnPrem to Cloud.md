...
# 1- On-Prem infrastructure design
 ## 1. Propose of the migration strategie for each of the components
  ...
  5. Email service → as email is a fully hosted and managed software applications that users access over the internet, this last would be represented by SAAS model in cloud.
